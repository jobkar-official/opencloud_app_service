...
public class DashboardController {
  ...
  public DashboardController(ServerRepository s, DeploymentRepository d) {
    serverRepo = s;
    deploymentRepo = d;
  }
  ...
  public String dashboard(Model m) {
    ...
    m.addAttribute("liveDeployments",
        deploymentRepo.findAll().stream().filter(d -> d.getStatus().name().equals("LIVE")).count());
